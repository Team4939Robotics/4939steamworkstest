...
public class DriveSubsystem extends Subsystem {
	...
	public CANTalon leftsidedrivefront = new CANTalon(RobotMap.leftDriveFront);
	public CANTalon leftsidedriveback= new CANTalon(RobotMap.leftDriveBack);
	public CANTalon rightsidedrivefront= new CANTalon(RobotMap.rightDriveFront);
    public CANTalon rightsidedriveback= new CANTalon(RobotMap.rightDriveBack);
...
{
	this.leftsidedrivefront.set(left);
	this.leftsidedriveback.set(left);
